#!/usr/bin/env python3
"""
Generate articles.md from the Dev Leader Homebase tag page.
...
_TAG_URL = 'https://www.devleader.ca/tags/Homebase'
...
def generate_markdown(articles: list[dict]) -> str:
    ...
    lines = [
        ...
        "",
        "!!! tip \"Stay Updated\"",
        "    Follow [Dev Leader](https://www.devleader.ca) for articles about Eleventy, static sites, personal branding, and developer tools.",
        "",
    ]
